#A função c cria um objeto que se associa a um conjunto de valores de um mesmo tipo
...
#Exercício 1
#Agora faça as adaptações no código que permitam responder ao que se pede.
#Altere o conjunto de dados sobre média de forma que este passe a possuir
#os seguintes valores: 404.45, 487.2 e 452.23. 
media_escola<- c(404.45, 487.2, 452.23)
...
#Exercício 2
#Agora reescreva o código para gerar uma tabela de frequência em ordem crescente.
