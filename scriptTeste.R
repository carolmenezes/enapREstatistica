...
#O operador de atribuição de valor a uma variável mais usando é "<-" 
base_triangulo <- 5 

#Na linha abaixo atribuímos o valor 3 à variável altura_triangulo 
altura_triangulo<- 3 

#Na linha abaixo aribuímos o resultado de (base_triangulo * altura_triangulo)/2 
#à variável area_triangulo 

area_triangulo<- (base_triangulo * altura_triangulo)/2 

#para ver o valor de area_triangulo execute a linha abaixo.
#O resultado aparecerá no console ou na aba Environment 
